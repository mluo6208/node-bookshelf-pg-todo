...
var HeightfieldMesh = exports.HeightfieldMesh = function (_Mesh) {
    ...
    function HeightfieldMesh(geometry, material) {
        ...
        var _this = (0, _possibleConstructorReturn3.default)(this, (HeightfieldMesh.__proto__ || Object.getPrototypeOf(HeightfieldMesh)).call(this, geometry, material, mass, physParams));
