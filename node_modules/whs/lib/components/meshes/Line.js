...
var Line = (0, _SoftbodyComponent.SoftbodyComponent)(_class = (0, _PhysicsComponent.PhysicsComponent)(_class = (0, _MeshComponent.MeshComponent)(_class = (_temp = _class2 = function (_Component) {
  (0, _inherits3.default)(Line, _Component);

  function Line(params) {
    (0, _classCallCheck3.default)(this, Line);

    var _this = (0, _possibleConstructorReturn3.default)(this, (Line.__proto__ || Object.getPrototypeOf(Line)).call(this, params, Line.defaults, Line.instructions));
  ...
  (0, _createClass3.default)(Line, [{
    ...
    value: function build() {
      ...
      if (this.physics) Native = _index2.RopeMesh;else Native = _three.Line;

      return new Promise(function (resolve) {
        _this2.native = new Native(_this2.buildGeometry(params), material, _this2.params);
    ...
    value: function buildGeometry() {
      ...
      var geometry = params.buffer || params.physics ? new _three.BufferGeometry() : new _three.Geometry();
      ...
      if (params.buffer || params.physics) {
        ...
        geometry.addAttribute('position', new _three.BufferAttribute(verts, 3));
