...
var Torusknot = (0, _SoftbodyComponent.SoftbodyComponent)(_class = (0, _PhysicsComponent.PhysicsComponent)(_class = (0, _MeshComponent.MeshComponent)(_class = (_temp = _class2 = function (_Component) {
  (0, _inherits3.default)(Torusknot, _Component);

  function Torusknot() {
    var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    (0, _classCallCheck3.default)(this, Torusknot);

    var _this = (0, _possibleConstructorReturn3.default)(this, (Torusknot.__proto__ || Object.getPrototypeOf(Torusknot)).call(this, params, Torusknot.defaults, Torusknot.instructions));
  ...
  (0, _createClass3.default)(Torusknot, [{
    ...
    value: function buildGeometry() {
      ...
      var GConstruct = params.buffer && !params.softbody ? _three.TorusKnotBufferGeometry : _three.TorusKnotGeometry;
