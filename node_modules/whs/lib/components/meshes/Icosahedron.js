...
var Icosahedron = (0, _SoftbodyComponent.SoftbodyComponent)(_class = (0, _PhysicsComponent.PhysicsComponent)(_class = (0, _MeshComponent.MeshComponent)(_class = (_temp = _class2 = function (_Component) {
  (0, _inherits3.default)(Icosahedron, _Component);

  function Icosahedron() {
    var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    (0, _classCallCheck3.default)(this, Icosahedron);

    var _this = (0, _possibleConstructorReturn3.default)(this, (Icosahedron.__proto__ || Object.getPrototypeOf(Icosahedron)).call(this, params, Icosahedron.defaults, Icosahedron.instructions));
  ...
  (0, _createClass3.default)(Icosahedron, [{
    ...
    value: function buildGeometry() {
      ...
      var GConstruct = params.buffer && !params.softbody ? _three.IcosahedronBufferGeometry : _three.IcosahedronGeometry;
