...
var Shape = (0, _MeshComponent.MeshComponent)(_class = (_temp = _class2 = function (_Component) {
  (0, _inherits3.default)(Shape, _Component);

  function Shape() {
    var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    (0, _classCallCheck3.default)(this, Shape);

    var _this = (0, _possibleConstructorReturn3.default)(this, (Shape.__proto__ || Object.getPrototypeOf(Shape)).call(this, params, Shape.defaults, Shape.instructions));

    if (params.build) {
      _this.build(params);
      (0, _get3.default)(Shape.prototype.__proto__ || Object.getPrototypeOf(Shape.prototype), 'wrap', _this).call(_this);
    }
    return _this;
  }
  ...
  (0, _createClass3.default)(Shape, [{
    ...
    value: function build() {
      ...
      return new Promise(function (resolve) {
        _this2.native = new _three.Mesh(_this2.buildGeometry(params), material);
    ...
    value: function buildGeometry() {
      ...
      var GConstruct = params.buffer && !params.softbody ? _three.ShapeBufferGeometry : _three.ShapeGeometry;
