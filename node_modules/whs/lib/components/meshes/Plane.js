...
var Plane = (0, _SoftbodyComponent.SoftbodyComponent)(_class = (0, _PhysicsComponent.PhysicsComponent)(_class = (0, _MeshComponent.MeshComponent)(_class = (_temp = _class2 = function (_Component) {
  (0, _inherits3.default)(Plane, _Component);

  function Plane() {
    var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    (0, _classCallCheck3.default)(this, Plane);

    var _this = (0, _possibleConstructorReturn3.default)(this, (Plane.__proto__ || Object.getPrototypeOf(Plane)).call(this, params, Plane.defaults, Plane.instructions));
  ...
  (0, _createClass3.default)(Plane, [{
    ...
    value: function build() {
      ...
      if (this.physics && this.params.softbody) MeshNative = _index.ClothMesh;else if (this.physics) MeshNative = _index.PlaneMesh;else MeshNative = _three.Mesh;
    ...
    value: function buildGeometry() {
      ...
      var GConstruct = params.buffer || params.softbody ? _three.PlaneBufferGeometry : _three.PlaneGeometry;
