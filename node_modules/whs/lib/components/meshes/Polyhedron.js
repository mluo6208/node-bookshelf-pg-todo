...
var Polyhedron = (0, _SoftbodyComponent.SoftbodyComponent)(_class = (0, _PhysicsComponent.PhysicsComponent)(_class = (0, _MeshComponent.MeshComponent)(_class = (_temp = _class2 = function (_Component) {
  (0, _inherits3.default)(Polyhedron, _Component);

  function Polyhedron() {
    var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    (0, _classCallCheck3.default)(this, Polyhedron);

    var _this = (0, _possibleConstructorReturn3.default)(this, (Polyhedron.__proto__ || Object.getPrototypeOf(Polyhedron)).call(this, params, Polyhedron.defaults, Polyhedron.instructions));
  ...
  (0, _createClass3.default)(Polyhedron, [{
    ...
    value: function build() {
      ...
      if (this.physics && this.params.softbody) MeshNative = _index.SoftMesh;else if (this.physics) MeshNative = _index.ConvexMesh;else MeshNative = _three.Mesh;
    ...
    value: function buildGeometry() {
      ...
      var GConstruct = params.buffer && !params.softbody ? _three.PolyhedronBufferGeometry : _three.PolyhedronGeometry;
  ...
  return Polyhedron;
}(_Component2.Component), _class2.verticesOfCube = verticesOfCube, _class2.indicesOfFaces = indicesOfFaces, _class2.defaults = (0, _extends3.default)({}, _Component2.Component.defaults, {
  geometry: {
