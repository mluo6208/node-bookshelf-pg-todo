...
var Lathe = (0, _SoftbodyComponent.SoftbodyComponent)(_class = (0, _PhysicsComponent.PhysicsComponent)(_class = (0, _MeshComponent.MeshComponent)(_class = (_temp = _class2 = function (_Component) {
  (0, _inherits3.default)(Lathe, _Component);

  function Lathe() {
    var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    (0, _classCallCheck3.default)(this, Lathe);

    var _this = (0, _possibleConstructorReturn3.default)(this, (Lathe.__proto__ || Object.getPrototypeOf(Lathe)).call(this, params, Lathe.defaults, Lathe.instructions));
  ...
  (0, _createClass3.default)(Lathe, [{
    ...
    value: function buildGeometry() {
      ...
      var GConstruct = params.buffer && !params.softbody ? _three.LatheBufferGeometry : _three.LatheGeometry;
